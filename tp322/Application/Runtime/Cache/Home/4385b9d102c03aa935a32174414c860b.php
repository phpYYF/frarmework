...
<head>
    ...
    <title>微留言演示案例</title>
    <link rel="stylesheet" type="text/css" href="/tp322/Public/message./msg.css" media="all" />
    <script type="text/javascript" src="/tp322/Public/laydate/laydate.js"></script>
</head>
<body id="message" onselectstart="return true;" ondragstart="return false;">
	<div class="container">
	  	<div class="qiandaobanner">
		  	<a href="/tp322/Public/message">
		  		<img src="/tp322/Public/message/wall.jpg" style="width:100%;" />
		  	</a>
	  	</div>
		<div class="cardexplain">
			<div class="window" id="windowcenter">
				...
				<h4 >查询留言</h4>
				<input placeholder="请选择时间需要查询的时间范围" class="px" type="text" id="start" value="<?php echo ($time?:''); ?>" name="time" style="width: 341px;">
  			...
  			<div class="history">
				<div class="history-date">
					<ul>
						<a><h2 class="first first1" style="position: relative;" id="btn">点击查询</h2></a>
						<li class="nob  mb">
	...
	<script type="text/javascript" src="/tp322/Public/message/jquery.js"></script>
	<script type="text/javascript"> 
		$("#btn").click(function(){
			...
			$.get("<?php echo U('home/msg/index');?>",{"time":time},function(data){
				console.log(data);
				$("#rongqi").html('');
				$("#rongqi").html(data);
			},'text');
