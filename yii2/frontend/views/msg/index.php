...
<body id="message" onselectstart="return true;" ondragstart="return false;">
	<div class="container">
		...
		<div class="cardexplain">
			...
			<h4 >查询留言</h4>
				<input placeholder="请选择时间需要查询的时间范围" class="px" type="text" id="start" value="" name="time" style="width: 341px;">

  			<div class="history">
				<div class="history-date">
					<ul>
						<a><h2 class="first first1" id="btn" style="position: relative;">点击留言</h2></a>
						<li class="nob  mb">
	...
	<script type="text/javascript"> 
		$("#btn").click(function(){
			...
			$.post("<?= \yii\helpers\Url::toRoute('msg/index') ?>",{"time":time},function(data){
				console.log(data);
				$("#rongqi").html('');
				$("#rongqi").html(data);
			},'text');
